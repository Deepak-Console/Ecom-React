...
const Cart = () => {
    ...
    return (
        <div className="container mx-auto mt-8 p-4 flex">
            <div className="w-2/3 mr-4 h-full overflow-y-auto">
                ...
                {cartItems.length === 0 ? (
                    ...
                    <div>
                        {cartItems.map((item) => (
                            <div key={item.productId} className="flex items-center justify-between border-b border-gray-300 py-4 mb-4">
            ...
            <div className="w-1/3">
                <div className="bg-gray-100 p-4 rounded h-[200px]">
