...
const CrackerShop = () => {
  ...
  return (
    <div className="mx-auto mt-1 p-4">
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
        <div className="col-span-1 bg-white p-4 h-screen overflow-y-auto shadow-lg">
          <h2 className="text-2xl font-bold mb-4">Categories</h2>
          <ul className="list-none p-0">
            <li className="mb-2">
              <button
                className={`w-full text-left text-gray-900 font-bold py-2 px-4 rounded-md ${selectedCategory === '' ? 'bg-blue-200' : 'hover:bg-gray-100'}`}
            ...
            {uniqueCategories.map((categoryId) => (
              <li key={categoryId} className="mb-2">
                <button
                  className={`w-full text-left text-gray-900 font-bold py-2 px-4 rounded-md ${selectedCategory === categoryId ? 'bg-blue-200' : 'hover:bg-gray-100'}`}
        ...
        <div className="col-span-4 bg-white p-4">
          <div className="mb-4">
            <div className="space-y-4 md:flex md:items-center md:justify-between">
              ...
              <div className="flex flex-col md:flex-row md:space-x-4">
                <select
                  className="w-full md:w-48 px-4 py-2 mt-2 md:mt-0 border border-gray-300 rounded-md text-gray-900"
                  value={sortBy}
              ...
              >
                ...
                <div className="p-4 flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-700 mb-1 h-10">{product.description}</p>
                  </div>
                  <div className="flex items-center justify-between mt-2">
                    ...
                    {isAddedToCart(product.id) ? (
                      <div className="flex items-center border border-black px-2">
                        ...
                        <span className="text-base font-bold text-gray-900 mx-2">
