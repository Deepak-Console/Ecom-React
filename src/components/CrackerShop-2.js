...
const CrackerShop = () => {
  ...
  const filteredProducts = products
    ...
    .sort((a, b) => {
      switch (sortBy) {
        case 'Popularity':
          // Add logic for popularity sorting
  ...
  return (
    <div className="container mx-auto mt-4 p-4 grid grid-cols-1 md:grid-cols-5 gap-4">
          ...
          <div className="space-y-4 md:flex md:items-center md:justify-between">
            <div className="flex flex-col md:flex-row md:space-x-4">
              ...
              <input
                ...
                className="w-full md:w-120 px-4 py-2 border border-gray-300 rounded-md text-gray-900"
                value={searchQuery}
            ...
            <div className="flex flex-col md:flex-row md:space-x-4">
              <select
                className="w-full md:w-48 px-10 py-2 mt-2 md:mt-0 border border-gray-300 rounded-md text-gray-400"
                value={sortBy}
          ...
          {filteredProducts.map((product) => (
            ...
            >
              ...
              <div className="p-4 md:p-6 flex flex-col justify-between">
                <div>
                  <h2 className="mb-2 text-lg font-medium text-gray-930000">
                    {product.name}
                  </h2>
                  <p className="text-sm text-gray-700 mb-1 h-10 truncate-last-line">{product.description}</p>
                </div>
